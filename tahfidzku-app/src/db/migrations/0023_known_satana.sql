...
ALTER TABLE "setoran" ADD COLUMN IF NOT EXISTS "ditinjau_oleh_ustadz" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "setoran" ADD COLUMN IF NOT EXISTS "respon_ustadz" jsonb;--> statement-breakpoint
