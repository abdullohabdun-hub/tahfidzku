...
export const Route = createFileRoute('/superadmin/tiket/buat')({
  component: SuperadminTiketBuat,
})

function SuperadminTiketBuat() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <TiketForm onSuccess={() => router.navigate({ to: '/superadmin/tiket' })} />
    </div>
  )
}
