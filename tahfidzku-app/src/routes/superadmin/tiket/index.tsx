...
export const Route = createFileRoute('/superadmin/tiket/')({
  component: SuperadminTiketIndex,
})

function SuperadminTiketIndex() {
  ...
  return (
    <div className="space-y-4">
      ...
      <TiketList 
        ...
        userId={user.id}
        baseUrl="/superadmin/tiket"
        onNewTicketClick={() => router.navigate({ to: '/superadmin/tiket/buat' })}
      />
    </div>
  )
}
