...
export const Route = createFileRoute('/ustadz/tiket/buat')({
  component: UstadzTiketBuat,
})

function UstadzTiketBuat() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4">
      ...
      <TiketForm onSuccess={() => router.navigate({ to: '/ustadz/tiket' })} />
    </div>
  )
}
