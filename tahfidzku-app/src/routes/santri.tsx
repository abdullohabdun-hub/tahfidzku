    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900 pb-20 md:pb-0">
      ...
      <header className="bg-white border-b border-slate-200 px-4 py-2.5 sticky top-0 z-50 shadow-xs">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/santri/notifikasi" className="relative p-1.5 text-slate-400 hover:text-primary hover:bg-slate-100 rounded-full transition-colors">
              <Bell className="w-4 h-4" />
              {unreadCount > 0 && (
                <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 border border-white rounded-full"></span>
              )}
            </Link>
            <Link to="/santri/profil" className="w-7 h-7 rounded-full bg-primary/15 text-primary flex items-center justify-center font-bold text-xs border border-primary/30 uppercase hover:ring-2 hover:ring-primary transition-all">
      ...
      <aside className="hidden md:flex fixed inset-y-0 left-0 w-64 bg-white border-r border-slate-200/60 flex-col z-40 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        <div className="p-6 flex items-center gap-2 border-b border-slate-100">
          ...
          <span className="font-bold text-xl tracking-tight text-slate-900 truncate">TahfidzKu</span>
          <Link to="/santri/notifikasi" className="relative ml-auto p-2 text-slate-500 hover:text-primary hover:bg-primary/10 rounded-full transition-colors">
