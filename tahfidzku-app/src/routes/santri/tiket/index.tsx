...
export const Route = createFileRoute('/santri/tiket/')({
  component: SantriTiketIndex,
})

function SantriTiketIndex() {
  ...
  return (
    <div className="space-y-4">
      ...
      <TiketList 
        ...
        userId={user.id}
        baseUrl="/santri/tiket"
        onNewTicketClick={() => router.navigate({ to: '/santri/tiket/buat' })}
      />
    </div>
  )
}
